...
# driver = webdriver.Chrome('D:\PythonCourse\chromedriver.exe')
...
def setUp():
    ...
    # give browser up to 30 seconds to response
    ...
    if driver.current_url == locators.moodle_url and driver.title == locators.moodle_home_page_title:
        ...
        print(f'{locators.app} did not launch!!')
...
# setUp()
# log_in(locators.admin_userename, locators.admin_password)
# create_new_user()
# search_user()
# log_out()
